/**
 * Instructors Layout Component
 * Layout: Contenitore con sotto-navigazione
 *
 * Responsabilità:
 * - Renderizzare header con selezione istruttore e data
...
import { OperatorSelectorComponent } from '../../operators-new/components/operator-selector/operator-selector.component';
...
@Component({
  selector: 'app-instructors-layout',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  template: `
    <div class="instructors-layout">
      <!-- Header con selezione istruttore e data -->
      <header class="layout-header">
        <div class="header-title">
          <h1>Workspace Istruttore</h1>
        </div>
...
export class InstructorsLayoutComponent implements OnInit {
