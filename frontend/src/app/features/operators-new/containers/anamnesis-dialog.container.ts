/**
 * Anamnesis Dialog Container
 * Layer 2: Smart Component - Dialog per Vista Espansa Anamnesi
 *
 * Responsabilità:
 * - Dialog fullscreen per visualizzazione comoda dell'anamnesi
 * - Mostra anamnesis-tab in modalità espansa
...
@Component({
  selector: 'app-anamnesis-dialog-container',
  standalone: true,
  imports: [
    CommonModule,
    MatDialogModule,
        ...
        <div class="anamnesis-dialog" (click)="$event.stopPropagation()">
          ...
          <div class="dialog-header">
            ...
            <div class="header-actions">
              <button mat-icon-button (click)="onEditClick()" matTooltip="Modifica anamnesi">
...
export class AnamnesisDialogContainer {
