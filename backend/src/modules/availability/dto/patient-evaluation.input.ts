...
import { ObjectiveType, TestSection } from '../entities/evaluation-enums';
...
@InputType()
export class EvaluationObjectiveInput {
  @Field({ nullable: true, description: 'ID per update, null per create' })
  @IsOptional()
  @IsUUID('4')
  id?: string;
...
@InputType()
export class EvaluationTestInput {
  @Field({ nullable: true, description: 'ID per update, null per create' })
  @IsOptional()
  @IsUUID('4')
  id?: string;
...
@InputType()
export class EvaluationExamInput {
  @Field({ nullable: true, description: 'ID per update, null per create' })
  @IsOptional()
  @IsUUID('4')
  id?: string;
...
export class CreateEvaluationInput {
  ...
  @Field(() => [EvaluationExamInput], { nullable: true })
  @IsOptional()
  @ValidateNested({ each: true })
  @Type(() => EvaluationExamInput)
  ...
  @Field(() => [EvaluationObjectiveInput], { nullable: true })
  @IsOptional()
  @ValidateNested({ each: true })
  @Type(() => EvaluationObjectiveInput)
  ...
  @Field(() => [EvaluationTestInput], { nullable: true })
  @IsOptional()
  @ValidateNested({ each: true })
  @Type(() => EvaluationTestInput)
  tests?: EvaluationTestInput[];
}

// ============================================================
// INPUT PER AGGIORNARE VALUTAZIONE
// ============================================================
