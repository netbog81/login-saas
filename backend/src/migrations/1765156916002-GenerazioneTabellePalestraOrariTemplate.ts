...
export class GenerazioneTabellePalestraOrariTemplate1765156916002 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."gym_exceptions_exceptiontype_enum" AS ENUM('closed', 'operator_absent', 'modified_hours'); EXCEPTION WHEN duplicate_object THEN NULL; END $$`);
