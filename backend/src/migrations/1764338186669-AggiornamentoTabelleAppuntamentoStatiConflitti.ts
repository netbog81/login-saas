...
export class AggiornamentoTabelleAppuntamentoStatiConflitti1764338186669 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."appointment_logs_eventtype_enum" AS ENUM('cancelled', 'no_show', 'operator_absent', 'rescheduled')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."availability_appointments_bookingstatus_enum" AS ENUM('scheduled', 'confirmed', 'cancelled', 'no_show')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."availability_appointments_treatmentstatus_enum" AS ENUM('waiting', 'in_progress', 'operator_completed', 'closed')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."availability_appointments_conflictreason_enum" AS ENUM('template_change', 'operator_sick', 'operator_vacation', 'operator_unavailable')`);
