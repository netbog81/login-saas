...
export class InitialSchema1763633879179 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."availability_exceptions_exceptiontype_enum" AS ENUM('unavailable', 'modified', 'holiday', 'sick', 'vacation'); EXCEPTION WHEN duplicate_object THEN NULL; END $$`);
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."availability_appointments_status_enum" AS ENUM('scheduled', 'confirmed', 'in_progress', 'completed', 'cancelled', 'no_show'); EXCEPTION WHEN duplicate_object THEN NULL; END $$`);
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."operators_operatortype_enum" AS ENUM('standard', 'gym', 'resource'); EXCEPTION WHEN duplicate_object THEN NULL; END $$`);
